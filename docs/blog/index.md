...
| [Chaos-Test Your AI Agent](11-agentic-fault-injection.md) | Deterministic and live-proxy fault injection for agent clients |
...
| [The Road Ahead](15-road-ahead.md) | Current capability boundaries, verification policy, priorities, and non-goals |
| [MCP over HTTP](16-mcp-http-transport.md) | Streamable HTTP transport for container and fleet integrations |
| [Tumult 1.0](17-tumult-1.0.md) | Historical release context for the first stable release |
