...
| [Autopilot: Chaos Engineering That Decides — and Shows Its Work](25-autopilot.md) | policy-gated autonomous fault injection: deterministic recommender + 13-rule safety gate, earned autonomy, decisions as graph lineage, parquet evidence archive — proven by three consecutive 12-proof demo runs |
