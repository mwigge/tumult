...
```bash
# Required only for the tumultd demo stack (docker-compose.kronika.yml):
# copy the template and fill in the three KRONIKA_* values.
cp ../.env.example ../.env   # from docker/; or run from the repo root
