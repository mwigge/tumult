//! `kronika-otel` — pure translation from OTLP protobuf requests
//! (`opentelemetry-proto` tonic types) to `kronika-store` row structs.
//!
...
//!
//! All functions are pure; I/O lives in `kronika-ingest`.
